...
<body background="background.jpg">
    ...
    <a href="atividades.html"><button class="btnatividades">Atividades</button></a>
    ...
    <a href="horario.html"><button class="btnhorario">Horario<br>de Aula</button></a>
    <img class="imghorario" src="imghorario.png"><img>

    <a href="manual.html"><button class="btnmanual">Manual<br>do Aluno</button></a>
